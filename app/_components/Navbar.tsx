...
function Navbar() {
  ...
  return (
    <div className="h-full z-50 p-8 text-2xl border-r-2 border-gray-200 flex flex-col bg-sky-800 lg:bg-gray-100">
      <h1 className="text-gray-100 phone:text-sky-800 font-semibold text-center">
        VaiDarPraia?
      </h1>
